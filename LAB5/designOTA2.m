...
for i=1:1:8
%Input Pair
OTA.M1.gm = specs.GBW * CLeff * 2 * pi;
...
OTA.M1.CDD_W=look_up(nch, 'CDD_W', 'GM_ID', OTA.M1.gm_ID, 'VDS', OTA.M1.VDS, 'L', OTA.M1.L);
OTA.M1.CDD=OTA.M1.CDD_W*OTA.M1.W;
OTA.M3.CDD_W = look_up(pch, 'CDD_W', 'GM_ID', OTA.M3.gm_ID, 'VDS', OTA.M3.VDS, 'L', OTA.M3.L);
OTA.M3.CDD=OTA.M3.CDD_W*OTA.M3.W;
CLeffnew=specs.CL + OTA.M1.CDD+OTA.M3.CDD;
if (((CLeffnew/CLeff) - 1)<0.001)
    break
end
CLeff=CLeffnew;
end
